        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HeadquartersAdress = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LoadUnloadInfos", x => x.Id);
                    table.ForeignKey(
                        name: "FK_LoadUnloadInfos_Cities_CityId",
                        column: x => x.CityId,
                        principalTable: "Cities",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_LoadUnloadInfos_Countries_CountryId",
                        column: x => x.CountryId,
                        principalTable: "Countries",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Weight = table.Column<int>(type: "int", maxLength: 17000, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LoadingId = table.Column<int>(type: "int", nullable: false),
                    UnloadingId = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Freights_LoadingId",
                table: "Freights",
                column: "LoadingId");

            migrationBuilder.CreateIndex(
                name: "IX_Freights_UnloadingId",
                table: "Freights",
                column: "UnloadingId");

            migrationBuilder.CreateIndex(
                name: "IX_Freights_UserId",
                table: "Freights",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_LoadUnloadInfos_CityId",
                table: "LoadUnloadInfos",
                column: "CityId");

            migrationBuilder.CreateIndex(
                name: "IX_LoadUnloadInfos_CountryId",
                table: "LoadUnloadInfos",
                column: "CountryId");
